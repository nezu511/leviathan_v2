...
mod state_tests {
    ...
    fn state_test() {
        ...
        // 対象のディレクトリ
        let test_dirs = vec![
            "MPTTest/stAttackTest", 
            "MPTTest/stBadOpcode",
            "MPTTest/stBugs",
            "MPTTest/stCallCodes",
            "MPTTest/stCallCreateCallCodeTest",
            "MPTTest/stCallDelegateCodesCallCodeHomestead",
            "MPTTest/stCallDelegateCodesHomestead",
            "MPTTest/stChangedEIP150",
            "MPTTest/stCodeSizeLimit",
            "MPTTest/stCreate2",
            "MPTTest/stCreateTest",
            "MPTTest/stDelegatecallTestHomestead",
            "MPTTest/stEIP158Specific",
            "MPTTest/stExtCodeHash",
            "MPTTest/stHomesteadSpecific",
            "MPTTest/stInitCodeTest",
            "MPTTest/stLogTests",
            "MPTTest/stMemoryStressTest",
            "MPTTest/stMemoryTest",
            "MPTTest/stQuadraticComplexityTest",
            "MPTTest/stRandom",
            "MPTTest/stRecursiveCreate",
            "MPTTest/stRefundTest",
            "MPTTest/stRevertTest",
            "MPTTest/stSStoreTest",
            "MPTTest/stShift",
            "MPTTest/stSolidityTest",
            "MPTTest/stStackTests",
            "MPTTest/stTimeConsuming",
            "MPTTest/stTransitionTest",
            "MPTTest/stWalletTest",
            "MPTTest/stZeroCallsRevert",
            "MPTTest/stZeroCallsTest",
            "MPTTest/stZeroKnowledge",
        ];
