...
| **stCallDelegateCodesCallCodeHomestead** | ✅ | **Pass** |
...
| **stCreate2** | ✅ | **Pass** |
| **stCreateTest** | ✅ | **Pass** |
| stDelegatecallTestHomestead | 🔄 | 未着手 |
| stEIP150Specific | 🔄 | 未着手 |
| stEIP150singleCodeGasPrices | 🔄 | 未着手 |
| stEIP158Specific | 🔄 | 未着手 |
| stExample | 🔄 | 未着手 |
| stExtCodeHash | 🔄 | 未着手 |
...
| テストスイート | 進捗 | 備考 |
| :--- | :---: | :--- |
| stHomesteadSpecific | 🔄 | 未着手 |
| **stInitCodeTest** | ✅ | **Pass** (一部bytecodeコンパイル失敗ファイルあり) |
| stLogTests | ✅ | Pass |
...
| stQuadraticComplexityTest | 🔄 | 未着手 |
| stRandom | 🔄 | 未着手 |
| stRandom2 | 🔄 | 未着手 |
| stRecursiveCreate | ✅ | Pass |
| **stRefundTest** | ✅ | **Pass** |
| stReturnDataTest | ❌ | MLOADの値が不一致 |
| **stRevertTest** | ✅ | **Pass** |
| **stSStoreTest** | ✅ | **Pass** (現在2ファイル) |
| stShift | 🔄 | 未着手 |
| **stSolidityTest** | ✅ | **Pass** |
| stSpecialTest | 🔄 | 未着手 |
| stStackTests | ✅ | Pass |
...
| stTransitionTest | 🔄 | 未着手 |
| **stWalletTest** | ✅ | **Pass** |
| stZeroCallsRevert | 🔄 | 未着手 |
| stZeroCallsTest | ❌ | SELFDESTRUCT 送金相手の未作成によるエラー |
